...
export const COMMAND_DOCK_ITEMS: readonly CommandDockItem[] = [
  ...
  { domain: 'strategy', label: '计略', availability: 'available', reason: 'S17 L1 四计 + L2 战略计谋唯一入口' },
  { domain: 'intel', label: '情报', availability: 'available', reason: 'S07 人员、任务、反间与俘虏唯一入口' },
  { domain: 'farming', label: '屯田', availability: 'available', reason: '民屯田分配与军屯田开关唯一入口（docs/04 §2.8、docs/05 §5.8.1）' },
