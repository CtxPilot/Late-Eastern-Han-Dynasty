...
| 项 | 状态 |
|----|------|
| 会话 | **Session 197 完成：CMD-P2**。朝廷成为命令坞首个真实业务域，政统/汉帝/皇权/开府/伪诏/官制只读已接入草稿与既有终审；旧君主验证期保留且数据同源 |
...
| 玩法下一步 | 等用户指派 CMD-P3（原位升级统一终审），之后 CMD-P4 原子删除旧“君主”并迁移 Headless 路径。当前新旧朝廷入口暂时双活但同读写一份权威状态，禁止延长至 CMD-P4 之后。HC-P1/R3 仍保持未启动。 |
