...
| 项 | 状态 |
|----|------|
| 会话 | **Session 122 完成**（武将名册/详情 + 人事操作统一终审窗） |
...
| 文档最新 | 本文件 · 10-progress v6.22 · 12-system-map v5.5 · 03-data-models v2.9 · 04-game-systems v4.7 · 01-overview v2.6 · 02-architecture v2.4 · 06-api-design v2.5 · 07-ui-design v3.4 · 09-roadmap v2.0 · 08-data-dictionary v2.2 · **14-officer-stats-reference v2.0** |
...
| S10 | 战斗 | **M+引擎/入口有缺陷** | 六角战斗、单挑引擎、暴击/反击/连击与战役 Army 编成/行军/围城/自动战斗已有实现；**单挑接受链路有嵌套锁400错误**，战役单挑也只是简化事件。**已设计**：阵型双轴成长体系（§4, Session 120）+ 工程器械6种Lv1~Lv3+城防体系+瓮城阶段式守城（§15, Session 121）。**部曲、军屯/民屯、爵位加成、S21串联未实装** |
| S11 | 人事 | **M+** | 搜索/登用 + 任命三轨 |
