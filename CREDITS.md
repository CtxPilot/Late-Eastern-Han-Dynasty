...
### 郡县历史地理资料入口（BF-P0 预登记）

| 资料 | 公共入口 | 本项目用途 | 当前状态 |
|:----|:---------|:----------|:---------|
| 《后汉书》 | [中国哲学书电子化计划](https://ctext.org/hou-han-shu/zh) | 《郡国志》郡县基线人工校勘入口 | 仅登记入口；正式数据录入时逐条校勘补充卷、条目、底本/版本与访问日期 |
| 《后汉书》卷一百一十二 | [维基文库](https://zh.wikisource.org/zh/%E5%BE%8C%E6%BC%A2%E6%9B%B8/%E5%8D%B7112) | 南郡等郡县条目人工复核入口 | 仅登记入口；正式数据录入时逐条校勘补充，不将网站整理或扫描资产视为自动可再分发 |

以上原典本体属于公有领域；不同网站的现代标点、排版、扫描图和整理成果可能另有权利。BF-P0 尚未录入具体南郡县表、坐标或路线，因此本节不声称任何具体数据已经校勘。建安改置、水系和县址定位仍须在正式录入时补充《三国志》及裴注、《水经注》等具体条目与版本差异记录。
