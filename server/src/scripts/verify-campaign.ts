...
function baseState(): GameState {
  ...
  return {
    ...
    females: {},
    factions: {
      1: { id: 1, name: '曹操军', color: '#4a6fa5', rulerId: 1, capitalCityId: 1, gold: 5000, food: 8000, courtNetwork: 0, cityIds: [1, 13], officerIds: [1, 13], isPlayer: false, isAlive: true },
      2: { id: 2, name: '刘备军', color: '#3d8b5a', rulerId: 2, capitalCityId: 15, gold: 5000, food: 8000, courtNetwork: 0, cityIds: [15, 19, 20], officerIds: [2, 6, 7, 10, 8], isPlayer: true, isAlive: true },
    },
    armys: [],
    campaignArmies: [],
    campaignNodes: [],
