...
>
> 🎮 本项目为完全独立的原创作品，与株式会社外部发行方特库摩（external publisher）及其旗下《三国志》《信长之野望》等任何游戏系列无任何商业关联、授权或合作关系。游戏中所有三国人物及历史事件素材均来源于《三国志》（陈寿·西晋）、《后汉书》（范晔·南朝宋）、《三国演义》（罗贯中·元末明初）等公有领域古籍。
>
> 🇺🇸 This project is an independent work. It is NOT affiliated with, endorsed by, or associated with external publisher Holdings Co., Ltd. or any of its game series (including *external historical strategy reference* / *external strategy reference*). All historical references are derived from public-domain classical texts.
>
