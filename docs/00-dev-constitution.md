...
- [x] 武将隐藏系统（11 项基础：相性/义理/野心/勇猛/冷静/寿命/成长/性格/理想/血缘/天花板加成；8 项单挑/舌战：力量/爆发/敏捷/运气/直觉/威压/谋略/奇谋，共 19 项；阵型精通与技能组为独立字段）
...
| 阵型数据（目标27种：18陆+9水；0-A 7条） | 孙膑兵法十阵 + 诸葛亮八阵 + 武经总要；规模以 `08-data-dictionary.md` 为准 |
...
- `@font-face` 声明**完全自定义、绝不与宿主系统重名**的工程内部别名
  ...
  - 说明：原计划用沐瑶软笔体，未找到可确认授权的稳定 woff2 源，改用马善政体；文件名统一为真实家族名 `MaShanZheng-Regular.woff2`，并随发行包保留 OFL、来源和 SHA-256
...
*文档版本: v1.8 | 最后更新: 2026-08-01（Session 267 隐藏属性计数与现行 11+8 类型口径对齐）*
