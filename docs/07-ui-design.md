...
>
> **Session 198 / CMD-P3 状态**：通用 `CommandDock`、`CommandDrawer` 与纯客户端草稿
...
> “进行”仍指向顶部既有入口；旧君主入口下线（CMD-P4）尚未开始。
...
- 官制只读列出大司马、录尚书事、都督中外诸军事及当前任职者；“前往人事·任命”只打开旧
  人事手风琴，不复制任命表单或官职状态。
- CMD-P2 验证期按用户批准暂时保留旧“君主”可提交入口；新旧入口均读写同一 Zustand
  `game` 权威快照，不维护领域业务缓存。此双入口只允许持续到 CMD-P4，届时原子删除旧入口。
...
开府后在左侧“君主”折叠项展示“皇权 N/100 · 伪诏冷却 就绪/N季”，并按存活目标列出
“伪诏宣战·势力名”。皇权不足、冷却中或已交战时按钮禁用，按钮正文与 title 均附具体原因；
...
*文档版本: v4.4 | 2026-07-26 | Session 198 CMD-P3 统一终审升级*
