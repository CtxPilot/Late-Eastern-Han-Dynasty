...
| ID | 系统 | 成熟度 | 要点 |
|:--:|------|:------:|------|
| S11 | 人事 | **M+** | **仅男将**搜索/登用已接权威 PRNG（32/32）；R2 修复义理/野心百分点并与 UI 同源；**CMD-P6～P8 已完成：**旧入口基线、命令坞只读名册与招贤搜索/登用写流程均落地，旧手风琴暂留至 P10；赏赐与任官迁移留 P9。`Officer.hegemonyPosition?` 单值轨道已承载霸府三职与王国六职 |
| S12 | 官职功绩体力 | **S/M+** | **0-A 精简任命**；体力完整；功绩等级字段/门槛仍未实现。**HC-P1-1～3 已完成：**相对称王门槛、阶段年龄、原子称王/王号与王国六职已落地；同一朝职轨道单值、每职势力唯一。王命封爵与爵位语义收口留 HC-P1-4 |
| S13 | 宝物 | S | — |
...
| S20 | **前端体验** | **S/M** | **CMD-P0～P5：**命令坞壳、朝廷域迁移与复盘完成。**CMD-P6～P8：**人事旧入口基线、只读名册、招贤搜索/登用均已接入；统一终审、取消保留草稿、成功清除、确认前重校验及 1440×900 Headless 已通过。**下一步：**P9 任官/赏罚与跨域跳转，P10 原子下线旧人事入口；其他命令域与 W1～W4 未完成项仍待实施 |
...
*v8.5 | Session 207 同步：S20 CMD-P6～P8 人事迁移完成；HC-P1-1～3 已实装*
