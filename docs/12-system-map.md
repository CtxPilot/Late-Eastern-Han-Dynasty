...
| S20 | **前端体验** | **S/D** | **Session 122/179 已实装：**人物名册、统一终审与四页签人物简册。**Session 196 CMD-P1：**§12 通用命令坞/抽屉/草稿壳。**Session 197 CMD-P2：**朝廷首个真实业务域（政统/汉帝/皇权/开府/伪诏/官制只读），旧君主入口留 CMD-P4 原子下线。**仍设计中：**CMD-P3/P4、其余命令域、W1~W4 未完成项及 0-B 前置技术债 |
