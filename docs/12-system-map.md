...
| S02 | 地图 | **M/D+** | 已实装行政大地图官道邻接；**已批准待 BF-P0～P6：**105 郡国历史模板、属县相对位置、郡内道路/水系/关渡与年代覆写 |
...
4. **当前批准主线**：独立战场 BF-P0 南郡资料/Schema → BF-P1 静态郡域闭环 → BF-P2 实例/场景栈/存档 → BF-P3 动态战况与整场复现 → BF-P4 颍川对照 → BF-P5/P6 扩量；其后驻军差异化
...
- **当前优先（Session 157）**：RNG 确定性收口计划阶段性完成；三个 S15 文件只保留行动/目标选择随机。未来仅在录像/回放或 AI 行为复现需求出现时再评估统一决策源。
...
*v8.0 | Session 162（批准独立战场 BF-P0～P6，更新 S02/S05/S10/S16 扩充顺序）*
