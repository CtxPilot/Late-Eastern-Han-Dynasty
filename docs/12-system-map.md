...
| S09 | **美女资源** | M+ | 寻访/攻城抢夺接权威 PRNG，确定续玩 25/25；赏赐/献美为确定性库存转移；**非历史女且不生成角色实体** |
...
| ID | 系统 | 成熟度 | 要点 |
|:--:|------|:------:|------|
| S11 | 人事 | **M+** | **仅男将**搜索/登用已接权威 PRNG（32/32）；赏赐；**任命三轨**（现有赏赐/任命确定性） |
...
4. **当前批准主线**：~~BF-P0 南郡资料/Schema~~ ✅ → **BF-P1 静态郡域闭环（下一步）** → BF-P2 实例/场景栈/存档 → BF-P3 动态战况与整场复现 → BF-P4 颍川对照 → BF-P5/P6 扩量；其后驻军差异化
...
- **当前优先（Session 165）**：BF-P0 已完成，等待 BF-P1 静态郡域闭环。S15 军事行动/目标选择及结算已统一权威 RNG；`plotAi.ts` / `spyAi.ts` 的 AI 决策边界仍留待 BF-P3“整场复现”或对应系统深化时收口。
...
*v8.1 | Session 165（同步 BF-P0 完成态、S15 RNG 当前边界与 BF-P1 下一步）*
