...
| S02 | 地图 | **M/D+** | 已实装行政大地图官道邻接；**BF-P0 已完成：**南郡 190 年严格 Schema、史料校勘、16 个战场县节点/11 路线/10 地标与边界入口；**待 BF-P1～P6：**运行时郡域闭环及扩展至 105 郡国模板 |
...
| S16 | 存档剧本 | **M/D+** | 两剧本目录、v1 信封、完整 GameState/跨引用、迁移、受锁内存恢复与可序列化 PRNG 已完成；**已批准待 BF-P2/P3：**冻结战场模板版本、序列化 `BattlefieldInstance`/`Encounter`、中途恢复与战场 AI 整场复现；生产存取与 SQLite 仍D |
