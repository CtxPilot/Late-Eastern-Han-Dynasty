...
### 六、0-B 前置技术债（D-0B-1~12）

> 本轮 Session 100 技术储备登记，0-B 扩容前必须先清。
...
*v4.2 | Session 100（技术储备：S20 前端体验 + S21 三级战斗串联 + 单挑演出层 + HeroCharacter 特殊造型 + 吕布鬼神降临 + 内政外交前端增强 + PCG 程序化美术 + 计谋三级联动视觉。零代码改动，方案文档化）*
