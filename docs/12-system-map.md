...
| S15 | AI | **M+** | 内政占位 + 谍报/计谋 + **出征占城** + **总军师自动态势切换** |
| S16 | 存档剧本 | **M/D** | 两剧本目录、选择、白名单已可玩；v1 信封、完整 GameState/跨引用、迁移、受锁内存恢复与可序列化 PRNG 已完成；S10、S03、S07/S17、S11、S18 结算已收口；其余玩法 RNG、生产存取与 SQLite 仍D |
...
- **当前优先（Session 155）**：S10、S03、S07/S17、S11、S18、S09 结算随机流已收口；下一独立模块为 `grandStrategist.ts`，之后统一审计 S15 AI 决策边界。
...
*v7.5 | Session 155（S09 美女资源确定性结算收口）*
