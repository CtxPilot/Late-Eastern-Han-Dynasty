...
| ID | 系统 | 成熟度 | 要点 |
|:--:|------|:------:|------|
| S11 | 人事 | **M+** | **仅男将**搜索/登用已接权威 PRNG（32/32）；R2 修复义理/野心百分点并与 UI 同源；**CMD-P6～P9 已完成：**名册、招贤、五轨任官、美女库存赏赐及正式跨抽屉导航均落地，旧手风琴暂留至 P10。 |
...
| S20 | **前端体验** | **S/M** | **CMD-P0～P5：**命令坞壳、朝廷域迁移与复盘完成。**CMD-P6～P9：**人事名册、招贤、五轨任官、赏罚及正式跨域导航已接入；旧手风琴保留至 **P10 原子切换**。其他命令域与 W1～W4 未完成项仍待实施 |
...
*v8.8 | Session 212 同步：HC-P1-1～6 全部完成并通过两剧本/存档/Headless 总验收；下一步 CMD-P10*
