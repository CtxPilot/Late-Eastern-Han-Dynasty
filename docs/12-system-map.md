...
| ID | 系统 | 成熟度 | 要点 |
|:--:|------|:------:|------|
| S11 | 人事 | **M+** | **仅男将**搜索/登用已接权威 PRNG（32/32）；R2 修复义理/野心百分点并与 UI 同源；**CMD-P6～P10 已完成：**名册、招贤、五轨任官、美女库存赏赐及正式跨抽屉导航均落地，命令坞人事抽屉为唯一入口。 |
...
| S20 | **前端体验** | **S/M** | **CMD-P0～P5：**命令坞壳、朝廷域迁移与复盘完成。**CMD-P6～P10：**人事名册、招贤、五轨任官、赏罚、正式跨域导航与旧入口原子下线已完成。其他命令域与 W1～W4 未完成项仍待实施 |
...
*v8.9 | Session 213 同步：CMD-P10 完成人事旧入口原子切换，命令坞人事抽屉成为唯一生产入口*
