...
| ID | 系统 | 成熟度 | 要点 |
|:--:|------|:------:|------|
| S11 | 人事 | **M+** | **仅男将**搜索/登用已接权威 PRNG（32/32）；R2 修复义理/野心百分点并与 UI 同源（合并验证20/20）；赏赐；**任命三轨** |
| S12 | 官职功绩体力 | **S/M+** | **0-A 精简任命**；功绩等级字段代码未实现，表在文档；功绩门槛未联动任命；体力已完整接入（Session 63/65）；**委任军团官职/爵位门槛（§39，设计完成）**
| S13 | 宝物 | S | — |
