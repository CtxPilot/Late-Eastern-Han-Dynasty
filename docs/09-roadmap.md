...
### 命令坞迁移子路线 CMD-P0～P10（Session 213 已推进至人事域收尾）
...
| CMD-P9 | 五轨任官、美女库存赏赐、正式跨抽屉导航 | ✅ 已完成 |
| CMD-P10 | 人事旧入口原子下线与总验收 | ✅ 已完成：旧 DOM=0，人事抽屉为唯一入口 |
| 后续域 | 外交 → 军事 | 尚未启动；外交必须先建立旧入口/权威 action/API/Headless 基线，不得直接切换 |
...
*文档版本: v2.6 | 2026-07-28 | Session 214 同步 HC-P1 完成与 CMD-P0～P10 朝廷/人事迁移进度*
